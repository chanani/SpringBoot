...
public class PageVO {
    ...
    private int pnCount = 10; // 페이지네이션 개수
     ...
     private List<Integer> pageList; // 페이지네이션을 list로 저장
    ...
    public PageVO(Criteria cri, int total) {
        ...
        // end페이지 재결정
        // 데이터가 25개 -> end = 10, realEnd = 3 => (실제 끝번호는 따라감)
        // 데이터가 153개 -> end = 20, realEnd = 16 (실제 끝번호는 따라감)
